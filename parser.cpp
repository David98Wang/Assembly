...
string command[CMDNUM]= {"LD", "LDi", "SD","SDi", "ADD", "ADDi", "SUB", "SUBi", "MUL", "MULi", "DIV", "DIVi", "JMP", "JZ", "JNZ", "JGZ", "JGEZ", "JLZ", "JLEZ"};//19
int numCommand[CMDNUM]= {   2,     2,    2,    2,     3,      3,     3,      3,     3,      3,     3,      3,     1,    2,     2,     2,      2,     2,      2};
map<string,int>numArg;
...
void printFileIn(string s) //debug
{
    cout<<s<<endl;
